...
class APIRateLimiterMiddleware():
    ...
    def __init__(self, wsgi_app, bucket_size, timespan_for_refill_in_milliseconds):
        ...
        ## Ratelimiter configuration setup

        self.bucket_size = bucket_size
        self.timespan_for_refill_in_milliseconds = timespan_for_refill_in_milliseconds
